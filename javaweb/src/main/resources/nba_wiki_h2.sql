...
MERGE INTO equipos (id, nombre, ciudad, conferencia, color_principal, abreviatura) KEY(id) VALUES
...
MERGE INTO jugadores (id, nombre, posicion, nacionalidad) KEY(id) VALUES
...
MERGE INTO campeonatos (id, anio, equipo_campeon_id, equipo_finalista_id, resultado_serie, mvp_finales_id) KEY(id) VALUES
(1,  2015, 1,  2,  '4-2', 4),
(2,  2016, 2,  1,  '4-3', 5),
(3,  2017, 1,  2,  '4-1', 8),
(4,  2018, 1,  2,  '4-0', 8),
...
MERGE INTO campeonato_roster (campeonato_id, jugador_id) KEY(campeonato_id, jugador_id) VALUES
(1, 1), (1, 2), (1, 3), (1, 4),
(2, 5), (2, 6), (2, 7),
(3, 1), (3, 8), (3, 2), (3, 3),
(4, 1), (4, 8), (4, 2), (4, 3),
