-- =========================================================
-- NBA Wiki - Base de datos de campeonatos
...
-- ---------------------------------------------------------
-- Tabla: campeonatos (una fila por final de la NBA)
-- ---------------------------------------------------------
...
-- ---------------------------------------------------------
-- Tabla puente: roster del equipo campeon en ese anio
-- ---------------------------------------------------------
...
-- ---------------------------------------------------------
-- Tabla: favoritos (campeonatos marcados por cada usuario)
-- ---------------------------------------------------------
...
-- =========================================================
-- DATOS: roster del campeon por anio
-- =========================================================
...
-- =========================================================
-- Consulta de ejemplo (la usaran los Servlets via JDBC)
-- =========================================================
-- SELECT c.anio, ec.nombre AS campeon, ec.ciudad, ec.color_principal, ec.abreviatura,
--        ef.nombre AS finalista, c.resultado_serie, j.nombre AS mvp
-- FROM campeonatos c
